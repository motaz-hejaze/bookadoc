...
class DocSession(models.Model):
    ...
    session_doctor = models.ForeignKey(CustomUser , on_delete=models.CASCADE, blank=True, null=True,  related_name="doctor_sessions" )
    session_patient = models.OneToOneField(CustomUser, on_delete=models.CASCADE, blank=False, null=False, related_name="patient_sessions")
    doctor_acceptance = models.BooleanField(_('D'))
